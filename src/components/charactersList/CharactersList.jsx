...
//     const [likedCharacters, setLikedCharacters] = useState(false);
                            ...
                            <CardContent sx={{ display: "flex", justifyContent: 'space-between', flexDirection: "column", minHeight: '120px' }} >
                                ...
                                <div className='btn-group'>
                                    ...
                                    <Button
                                        ...
                                        style={{
                                            color: '#00bfff',
                                            backgroundColor: likedCharacters[character.id] ? '#00bfff' : 'transparent',
                                            borderRadius: '50%',
                                            padding: '6px',
                                            cursor: 'pointer',
                                            display: 'flex',
                                    ...
                                    >
                                        <FaRegHeart
                                            className={`heart-icon ${clickedHeart === character.id ? 'clicked' : ''}`}
                                            style={{
                                                color: likedCharacters[character.id] ? 'white' : '#00bfff',
                                                width: '24px',
                                                height: '24px'
                                            }}
                                        />
